import { GraphQLScalarType, Kind } from "https://cdn.skypack.dev/graphql?dts";
import type { GraphQLScalarTypeConfig } from "https://cdn.skypack.dev/graphql?dts";
import { validateJSDate, validateTime } from "./validator.ts";
import { parseTime, serializeTime, serializeTimeString } from "./formatter.ts";
